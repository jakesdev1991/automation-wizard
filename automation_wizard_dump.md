# Automation Wizard App – Code Dump (2025-12-01)

--- # FILE: package.json ---
{
  "name": "automation-wizard-app",
  "version": "0.2.0",
  "private": true,
  "scripts": {
    "dev": "vite",
...
const config = {
  ...
  compilerOptions: {
    // we’re not using runes in this app yet, this keeps it simple
    runes: false
  }
};
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Automation Wizard Canvas</title>
...
if (target) {
  ...
  console.error('No #app element found to mount Automation Wizard');
}
...
<script lang="ts">
  ...
  function useAutomationWizardAgent() {
    activeView = 'canvas';
    helperMessage =
      'Automation Wizard: Imagine your client is sitting next to you. Build the flow top-to-bottom, then use the Report tab to summarize it for them.';
  }
  ...
  {#if activeView === 'canvas'}
    <section class="aw-grid">
      ...
      <div class="aw-column glass aw-canvas-column">
        ...
        <p class="section-sub">
          Nodes are stacked vertically so every step stays visible. Drag them to reorder the story.
        </p>
        ...
        <ul class="hint-list">
          ...
          <li>Add extra triggers/actions/outputs from the left to match the real business flow.</li>
  ...
  {:else if activeView === 'report'}
    ...
    <section class="aw-grid single">
      <div class="aw-column glass">
        ...
        <p class="section-sub">
          Turn the canvas into a plain-language description you can hand to a child, a client, or a junior builder.
        </p>
        ...
        <p class="section-sub">
          Interview trick: read the top as a technical spec, then the kid-level bullets as proof you can talk to non-technical people.
        </p>
      </div>
      <div class="aw-column glass helper">
        <h2 class="section-title">Developer notes</h2>
        <p class="section-sub">
          Later this page becomes the export hub: JSON for n8n/Zapier, code stubs, etc. For now the text report is the “single source of truth”.
        </p>
        <ul class="hint-list">
          <li>Keep step names short and concrete – tools and verbs.</li>
          <li>Mention external systems explicitly (HubSpot, Gmail, Ghost, etc.).</li>
          <li>Practice getting from canvas → report in under 5 minutes.</li>
        </ul>
      </div>
    </section>
  {:else}
    ...
    <section class="aw-grid single">
      <div class="aw-column glass">
        ...
        <p class="section-sub">
          Goal: by tonight you can design, explain, and spec an automation for a real business – even if you’ve never used Zapier or n8n before.
        </p>

        <ol class="onboard-steps">
          <li>
            <strong>Pick a template on the Canvas tab.</strong><br />
            Example: tanning salon or Ghost blog loop. Read each step out loud.
          </li>
          <li>
            <strong>Rename steps in your own words.</strong><br />
            Could a 10-year-old guess what happens from the label alone?
          </li>
          <li>
          ...
          <li>
            ...
            Read it out loud as if you were talking to a client.
          </li>
          <li>
            <strong>Translate that report into real tools.</strong><br />
            For each step, answer: “Is this a Trigger, an Action, or an Output?”
          </li>
        </ol>
      </div>

      <div class="aw-column glass helper">
        <h2 class="section-title">Teacher Agent checklist</h2>
        <p class="section-sub">
          If you can honestly say “yes” to these, you’re job-ready for basic automation work.
        </p>
        <ul class="hint-list">
          ...
          <li>I can explain the system to a non-technical client without jargon.</li>
        </ul>
      </div>
    </section>
  {/if}
